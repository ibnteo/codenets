...
const uint8_t Layer_Mods[12] PROGMEM = {
    ...
    HID_KEYBOARD_SC_LEFT_CONTROL,     // Alt
    HID_KEYBOARD_SC_LEFT_SHIFT , // Ctrl
    HID_KEYBOARD_SC_BACKSPACE,   // Shift
    HID_KEYBOARD_SC_BACKSPACE,        // Space
    HID_KEYBOARD_SC_SPACE,        // Fn
    HID_KEYBOARD_LAYER_FN     // AltGr
};
